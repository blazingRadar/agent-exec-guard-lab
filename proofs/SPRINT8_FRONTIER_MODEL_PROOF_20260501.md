...
cd4b82640233b8bbcf76a8ebf1d3103c0d66156f3f06ecb1dc05f94d1e028aa4  scripts/integration/replay_sprint8_frontier_agent.sh
...
Sprint 7:  pass=7  fail=0  proofs/sprint7_runs/sprint7-headless-agent-20260501T015249Z
Sprint 8:  pass=10 fail=0  proofs/sprint8_runs/sprint8-frontier-agent-20260501T015857Z
```

One Sprint 7 audit replay at `proofs/sprint7_runs/sprint7-headless-agent-20260501T015134Z` failed `4/3` because OpenHands persistent session state from the fixed `sid` contaminated rerun behavior. That failure is preserved as a harness idempotency finding; clean reruns at `T015226Z` and `T015249Z` passed `7/0`.
