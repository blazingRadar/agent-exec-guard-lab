...
from openhands.runtime.plugins.agent_skills import AgentSkillsRequirement  # noqa: E402
...
async def main():
    ...
    # CodeActAgent also requests the Jupyter plugin, which is outside this gate
    # and adds a second Python execution surface unrelated to the command path.
...
volumes = "{ROOT}:/lab:rw,{SOURCE_DIR}:/openhands/code:ro,{RUN_ROOT / 'workspace'}:/workspace:rw"
runtime_startup_env_vars = {{ PYTHONPATH = "/openhands/code" }}
""",
        encoding="utf-8",
    )
